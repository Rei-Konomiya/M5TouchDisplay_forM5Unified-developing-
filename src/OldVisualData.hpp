#ifndef OLD_VISUAL_DATA_HPP
#define OLD_VISUAL_DATA_HPP
...
public:
  ...
  */
  ...
  OldVisualData(LovyanGFX* parent, bool enableErrorLog, bool enableInfoLog, bool enableSuccessLog);
  ...
  bool setDrawStringObject      (String objectName, int32_t x, int32_t y, String text, int color, int bgcolor, uint8_t datum, uint8_t zindex = 0);
